...
### Загрузитесь в UEFI
> Замените `путь\к\DEVICENAME-uefi.img` действительным путём к образу UEFI
```cmd
...
> Перейдите в Проводник Windows > Этот компьютер и выберите **WINDEVICENAME**. Щелкните правой кнопкой мыши и отформатируйте как NTFS.
